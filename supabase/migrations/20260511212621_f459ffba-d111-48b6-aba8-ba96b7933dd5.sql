-- Add timer_duration column
ALTER TABLE public.auctions ADD COLUMN IF NOT EXISTS timer_duration INTEGER DEFAULT 15;

-- Update place_bid function
...
BEGIN
  ...
  -- 4. Update auction
  -- Reset end_time to now() + timer_duration
...
-- Update place_robot_bid function
...
-- Update process_robot_bids to use dynamic timer
...
BEGIN
    -- Encontrar leilões ativos que tenham robôs habilitados
    -- Robôs agem quando o tempo está abaixo do timer_duration
    FOR v_auction IN 
